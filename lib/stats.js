...
Stats.prototype = {
  ...
  cdf: function(value) {
    ...
    var valuesLessThanOrEqualTo = this._sorted.reduce(function(total, item) {
      if (this.compare(item, value) <= 0) total++;
      return total;
    }.bind(this), 0);

    return valuesLessThanOrEqualTo / this._sorted.length;
  }
